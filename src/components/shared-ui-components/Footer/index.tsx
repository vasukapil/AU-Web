      ...
      <div className="container px-5 py-6 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          ...
          <p className="mt-2 text-sm text-white">
            Fusce et turpis mauris. Suspendisse viverra non ligula non eleifend.
            Pellentesque imperdiet blandit est,
          </p>
        </div>
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-slate-300 tracking-widest text-sm mb-3">
              Build
            </h2>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
...
export const Contact = () => {
  return (
    <>
      <section className="min-h-screen bg-white dark: bg-zinc-200">
